...
describe(__filename, () => {
    ...
    describe('getActiveOrders', () => {
        it('success', async () => {
            ...
            expect(httpProvider.get).toHaveBeenLastCalledWith(`${url}/orders/v2.0/1/order/active/?page=1&limit=2`);
        });
        it('passes without providing args', async () => {
            ...
            expect(response).toEqual(expected);
            expect(httpProvider.get).toHaveBeenLastCalledWith(`${url}/orders/v2.0/1/order/active/?`);
        });
    });
    describe('getOrderStatus', () => {
        it('success', async () => {
            ...
            expect(response).toEqual(expected);
            expect(httpProvider.get).toHaveBeenLastCalledWith(`${url}/orders/v2.0/1/order/status/${orderHash}`);
        });
    ...
    describe('getOrdersByMaker', () => {
        it('success', async () => {
            ...
            expect(response).toEqual(expected);
            expect(httpProvider.get).toHaveBeenLastCalledWith(`${url}/orders/v2.0/1/order/maker/${address}/?limit=1&page=1`);
        });
        it('handles the case when no pagination params was passed', async () => {
            ...
            expect(response).toEqual(expected);
            expect(httpProvider.get).toHaveBeenLastCalledWith(`${url}/orders/v2.0/1/order/maker/${address}/?`);
        });
